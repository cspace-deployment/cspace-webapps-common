#
# helper script to transcode a .mp4 file to 2 files: a 500kp/s version with no sound
#
FFMPEG=/srv/nfs/media/ffmpeg/ffmpeg
echo `date` > $1.transcode.log
if [[ -e $1.mp4 ]]; then
    #time $FFMPEG    -i $1.mp4 -c:v libx264 -b:v 500K  -b:a 64K    -movflags +faststart $1_500k.mp4 > $1.transcode.log 2>&1 &
