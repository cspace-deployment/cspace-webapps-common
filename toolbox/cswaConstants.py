...
def getAltNumTypes(form, csid, ant):
    ...
    altnumtypelist = [
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum13)'song number'",
            "song number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum14)'tag'",
            "tag"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum08)'previous number (collector's original number)'",
            "prev. number (collector"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum12)'previous number (UCAS: University of California Archaeological Survey)'",
            "prev. number (UCAS)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum21)'previous number (Anson Blake’s number)'",
            "prev. number (Anson Blake)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum10)'previous number (Lila M. O'Neale)'",
            "prev. number (Lila M. O"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum23)'previous number (UC Paleontology Department)'",
            "prev. number (UC Paleontology)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum04)'museum number (recataloged to)'",
            "museum number (recataloged to)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum22)'previous number (donor's original number)'",
            "prev. number (donor"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum16)'(null)'",
            "(null)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum20)'previous museum number (recataloged from)'",
            "prev. museum number (recat. from)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum11)'previous number (MVC number, Mossman-Vitale collection)'",
            "prev. number (MVC number)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum01)'attributed PAHMA number'",
            "attributed PAHMA number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum06)'previous number (Albert Bender’s number)'",
            "prev. number (Albert Bender)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum09)'previous number (Design Dept.)'",
            "prev. number (Design Dept.)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum19)'original number'",
            "original number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum07)'previous number (Bascom’s number)'",
            "prev. number (Bascom)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum02)'burial number'",
            "burial number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum15)'temporary number'",
            "temporary number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum05)'previous number'",
            "previous number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum03)'moac subobjid'",
            "moac subobjid"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum18)'field number'",
            "field number"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaaltnumber):item:name(altnum17)'associated catalog number'",
