...
def tricoderUsers():
    ...
    return{'A1732177': "urn:cspace:pahma.cspace.berkeley.edu:personauthorities:name(person):item:name(7827)'Michael T. Black'",
              ...
              'E10149033': "urn:cspace:pahma.cspace.berkeley.edu:personauthorities:name(person):item:name(7652)'Natasha Johnson'",
...
def getLegacyDepts(form, csid, ld):
    ...
    legacydeptlist = [
        ...
        ("Africa (except Ancient Egypt)", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment08)'Africa (except Ancient Egypt)'"),
        ("Ancient Egypt", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment09)'Ancient Egypt'"),
        ("Europe and western Russia (except Classical Mediterranean)", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment10)'Europe and western Russia (except Classical Mediterranean)'"),
        ("Classical Mediterranean", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment11)'Classical Mediterranean'"),
        ("Asia (except western Russia)", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment12)'Asia (except western Russia)'"),
        ("Oceania", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment13)'Oceania'"),
        ("Audio recordings", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment14)'Audio recordings'"),
        ("Casts and molds", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment15)'Casts and molds'"),
        ("Drawings and paintings", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment16)'Drawings and paintings'"),
        ("Maps", "urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaTmsLegacyDepartments):item:name(pahmaTMSLegacyDepartment17)'Maps'"),
...
def getObjectStatuses(form, csid, ant):
    ...
    objectstatuslist = [
        ...
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(intendedfortransfertofederalstateagency1674679913682)'intended for transfer to federal/state agency'",
            "intended for transfer to federal/state agency"),
        ...
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(nonaffiliatedHSRnotNAGPRAeligible1664832613176)'non-affiliated HSR (not NAGPRA eligible)'",
            "non-affiliated HSR (not NAGPRA eligible)"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(notaccessioned1664208917939)'not accessioned'",
            "not accessioned"),
        ...
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(pahmaObjectStatuses27)'repatriated'",
            "repatriated"),
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(repatriatedvoluntarily1705080621797)'repatriated voluntarily'",
# prod  ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(repatriatedvoluntarily1697554635050)'repatriated voluntarily'",
        ...
        ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(pahmaObjectStatuses31)'transferred'",
            "transferred"),
         ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(transferredtomuseum1674243502433)'transferred to museum'",                                             
             "transferred to museum"),
         ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(transferredtofederalstateagency1664461187560)'transferred to federal/state agency'",                   
             "transferred to federal/state agency"),
         ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011noticed1705081061631)'10.11 (noticed)'",                                                           
# prod   ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011Noticed1699571305608)'10.11 (noticed)'",                                                           
             "10.11 (noticed)"),
         ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011transferred1705081061703)'10.11 (transferred)'",                                                   
# prod   ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011Transferred1699571305669)'10.11 (transferred)'",                                                   
             "10.11 (transferred)"),
         ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011reinterred1705081061766)'10.11 (reinterred)'",                                                     
# prod   ("urn:cspace:pahma.cspace.berkeley.edu:vocabularies:name(pahmaObjectStatuses):item:name(1011Reinterred1699571305723)'10.11 (reinterred)'",                                                     
             "10.11 (reinterred)"),
