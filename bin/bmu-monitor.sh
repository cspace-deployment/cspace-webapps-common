...
for t in botgarden cinefiles pahma ucjeps; do python3 /var/www/$t/uploadmedia/checkRuns.py ${HOMEDIR}/bmu/$t jobs summary $t | mail -r "cspace-support@lists.berkeley.edu" -s "recent $t BMU jobs" jblowe@berkeley.edu,rjaffe@berkeley.edu; done
...
bash -l -c 'python3 /var/www/pahma/uploadmedia/bmu-nightly-2022-concise.py /var/www/static > /dev/null'
